...
start = col8.date_input('start' , datetime.date(2021,08, 17) ; start = int(start.timetuple().tm_yday) #; st.sidebar.write(start)
end = col9.date_input('end', datetime.date(2021,08,31) ; end =  int(end.timetuple().tm_yday) #; st.sidebar.write(end)
